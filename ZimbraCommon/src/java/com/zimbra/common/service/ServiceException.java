...
public class ServiceException extends Exception {
    ...
    public static final String MULTIPLE_ZCS_ACCOUNT_NOT_SUPPORTED_AUTO_ARCHIVING_ENABLED = "service.MULTIPLE_ZCS_ACCOUNT_NOT_SUPPORTED_AUTO_ARCHIVING_ENABLED";
    ...
    public static ServiceException MULTIPLE_ZCS_ACCOUNT_NOT_SUPPORTED_AUTO_ARCHIVING_ENABLED() {
        return new ServiceException("Cannot add multiple ZCS account: ",
                MULTIPLE_ZCS_ACCOUNT_NOT_SUPPORTED_AUTO_ARCHIVING_ENABLED, SENDERS_FAULT);
    }
}

...
public class AccountServiceException extends ServiceException {
    ...
    public static final String TWO_FACTOR_AUTH_EXPIRED = "account.TWO_FACTOR_AUTH_EXPIRED";
    ...
    public static AccountServiceException TWO_FACTOR_AUTH_REQUIRED() {
        return new AccountServiceException("two factor authentication code is required", TWO_FACTOR_AUTH_REQUIRED, RECEIVERS_FAULT);
    }

    public static AccountServiceException TWO_FACTOR_AUTH_EXPIRED() {
        return new AccountServiceException("two factor trustedtoken has expired", TWO_FACTOR_AUTH_EXPIRED, RECEIVERS_FAULT);
    }

...
public class OfflineDataSource extends DataSource {
    ...
    private static final String SERVICE_NAME_YAHOO_JP = "yahoo.co.jp";
    ...
    public boolean isYahoo() {
        return knownService != null && (knownService.getName().equals(SERVICE_NAME_YAHOO) || knownService.getName().equals(SERVICE_NAME_YAHOO_JP));
    }
    ...
    public boolean needsSmtpAuth() {
        return isEmail() && isSmtpEnabled() && !isLive();
    }

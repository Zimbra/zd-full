...
public class OfflineLC {
    ...
    public static final KnownKey zdesktop_gmail_imap_host;
    public static final KnownKey zdesktop_gmail_smtp_host;
    
    public static final KnownKey zdesktop_yahoo_imap_host;
    public static final KnownKey zdesktop_yahoo_smtp_host;
    
    public static final KnownKey zdesktop_yahoo_imap_host_jp;
    public static final KnownKey zdesktop_yahoo_smtp_host_jp;

    public static final KnownKey zdesktop_yahoo_imap_ssl_port;
    public static final KnownKey zdesktop_yahoo_smtp_ssl_port;
    ...
    public static final KnownKey zdesktop_auto_archive_start_time;
    public static final KnownKey zdesktop_auto_archive_on_startup_time;
    public static final KnownKey zdesktop_auto_archive_retry_time;
    public static final KnownKey zdesktop_auto_archive_batch_size;
    public static final KnownKey zdesktop_auto_archive_sleep_time;
    public static final KnownKey zdesktop_disable_password_lock;
...
//        zdesktop_yoauth_consumer_secret.setDefault("5c593062703d28de06085806c6016e4edce729b4");
        ...
        //Gmail IMAP host
        zdesktop_gmail_imap_host = new KnownKey("zdesktop_gmail_imap_host");
        zdesktop_gmail_imap_host.setDefault("imap.gmail.com");
        
        //Gmail SMTP host
        zdesktop_gmail_smtp_host = new KnownKey("zdesktop_gmail_smtp_host");
        zdesktop_gmail_smtp_host.setDefault("smtp.gmail.com");
        
        //Yahoo IMAP host
        zdesktop_yahoo_imap_host = new KnownKey("zdesktop_yahoo_imap_host");
        zdesktop_yahoo_imap_host.setDefault("imap.mail.yahoo.com");
        
        //yahoo SMTP host
        zdesktop_yahoo_smtp_host = new KnownKey("zdesktop_yahoo_smtp_host");
        zdesktop_yahoo_smtp_host.setDefault("smtp.mail.yahoo.com");
        
        //Yahoo IMAP Japan host (yahoo.co.jp)
        zdesktop_yahoo_imap_host_jp = new KnownKey("zdesktop_yahoo_imap_host_jp");
        zdesktop_yahoo_imap_host_jp.setDefault("imap.mail.yahoo.co.jp");
        
        //Yahoo SMTP Japan host(yahoo.co.jp)
        zdesktop_yahoo_smtp_host_jp = new KnownKey("zdesktop_yahoo_smtp_host_jp");
        zdesktop_yahoo_smtp_host_jp.setDefault("smtp.mail.yahoo.co.jp");
        ...
        // Yahoo SMTP ssl port
        zdesktop_yahoo_smtp_ssl_port = new KnownKey("zdesktop_yahoo_smtp_ssl_port");
        zdesktop_yahoo_smtp_ssl_port.setDefault("465");

        //Yahoo IMAP ssl port
        zdesktop_yahoo_imap_ssl_port = new KnownKey("zdesktop_yahoo_imap_ssl_port");
        zdesktop_yahoo_imap_ssl_port.setDefault("993");
        ...
        zdesktop_gab_base_url.setDefault("https://www.google.com/m8/feeds");
        ...
        zdesktop_auto_archive_start_time = new KnownKey("zdesktop_auto_archive_start_time");
        zdesktop_auto_archive_start_time.setDefault(Long.toString(15));

        zdesktop_auto_archive_on_startup_time = new KnownKey("zdesktop_auto_archive_on_startup_time");
        zdesktop_auto_archive_on_startup_time.setDefault(Long.toString(30));

        zdesktop_auto_archive_retry_time = new KnownKey("zdesktop_auto_archive_retry_time");
        zdesktop_auto_archive_retry_time.setDefault(Long.toString(30));

        zdesktop_auto_archive_batch_size = new KnownKey("zdesktop_auto_archive_batch_size");
        zdesktop_auto_archive_batch_size.setDefault(100);

        zdesktop_auto_archive_sleep_time = new KnownKey("zdesktop_auto_archive_sleep_time");
        zdesktop_auto_archive_sleep_time.setDefault(50);

        zdesktop_disable_password_lock = new KnownKey("zdesktop_disable_password_lock");
        zdesktop_disable_password_lock.setDefault(Boolean.toString(false));
    }

...
/*
* Portions Copyright (c) Zimbra, Inc. [2008 - 2014]. All Rights Reserved.
*/
...
function onload(aEvent)
{
  ...
  version.value = bundle.GetStringFromName("brandFullName") + " @version@ @relabel@ (build @buildid@)";

  var userAgent = document.getElementById("useragent");
  userAgent.value = "Portions Copyright \u00A9 2008-2016 Synacor, Inc. \nAll rights reserved.";

...
public	abstract	class	TemplateHandler {
    ...
    /**
     * Gets the templates directory property.
     * 
     * @param	context		the context
     * @return	the tempate directory property
     */
    ...
    /**
     * Gets the build version property.
     * 
     * @param	context		the context
     * @return	the build version property
     * @see		DEFAULT_BUILD_VERSION
     */
    ...
    /**
     * Gets the build date property. If not specified, the current date/time is used.
     * 
     * @param	context		the context
     * @return	the build date property
     */

...
ZmSpreadSheetToolbars = function(parentContainer, spreadSheet, controller) {
	...
	this._buttons = {};
	this._createWidgets();
	if (parentContainer === spreadSheet) {
		var parentEl = parentContainer.getHtmlElement();
        //var htmlEl = this.getHtmlElement();        
		parentEl.insertBefore(this.getHtmlElement(), parentEl.firstChild);
	}
...
ZmSpreadSheetToolbars.prototype._createToolbar2 = function(toolbar) {

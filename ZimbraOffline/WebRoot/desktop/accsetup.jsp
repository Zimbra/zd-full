...
function OnCancelTwoFactor() {
    var elem = document.getElementById("twoFactorDetails");
    if (elem) {
        elem.style.display = "none";
    }

    elem = document.getElementById("errorDesc");
    if (elem) {
        elem.style.display = "none";
    }

    elem = document.getElementById("accountDetails");
    if (elem) {
        elem.style.visibility = "visible";
        elem.style.display = "block";
        elem = document.getElementById("titleDiv");
        if (elem) {
            elem.innerHTML =  "<fmt:message key='AccountAdd'></fmt:message>";
        }
    }
}

function OnApplyTwoFactor(twoFactorInfoMsg) {
    var  elem = document.getElementById("accountDetails");
    if (elem) {
        elem.style.display = "none";
    }
    ...
    elem = document.getElementById("titleDiv");
    if (elem) {
        elem.innerHTML =  "<fmt:message key='TwoStepAuth'/>";
    }

    elem = document.getElementById("twoFactorDetails");
    if (elem) {
        elem.style.visibility = "visible";
        elem.style.display = "block";
    }

    elem = document.getElementById("twoFactorInfo");
    if (elem) {
        elem.innerHTML = twoFactorInfoMsg;
    }
}
...
function OnSubmit() {
    /* Perform two factor handling in the beginning because if two factor code is required and it is blank,
     * then we show error message and don't submit the form.
     */
    var elem = document.getElementById("twoFactorDetails");
    if (elem && elem.style.display !== 'none') {//Two-step authentication tab is visible
       elem = document.getElementById("code");
       if (elem.value.length > 0) {
           zd.set("twoFactorCode", elem.value);
           zd.enable("twoFactorCode");
       }
       else { //Two factor code is blank. Show error message and return.
           elem = document.getElementById("twoFactorErrorDiv");
           if (elem) {
               elem.innerHTML = "<fmt:message key='Two_Factor_Code_Blank'/>";
           }
           return;
       }
    }
    ...
    <td>
        <div class="ZPanel">
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=100%>
                    ...
                    <td class="ZPanelTabs">
                        <table border=0 cellpadding=0 cellspacing=0>
                            <tr>
                                ...
                                <td>
                                    <div class="ZPanelTabActive ZPanelTab" id="titleDiv">
                                        <c:choose>
                                            <c:when test="${bean.twoFactorAuthRequried}">
                                                <fmt:message key='TwoStepAuth'></fmt:message>
                                            </c:when>
                ...
                <tr>
                    <td class="ZPanelInfoOuter"  id="twoFactorDetails" style="${bean.twoFactorAuthRequried ? 'display:block' : 'display: none'}">
                        <div class="ZPanelInfoInner">
                            <center>
                                <table border=0 cellpadding=0 cellspacing=0 class="ZTable">
                                    <tr>
                                        <td colspan="2">
                                            <div class='ZTwoFactorInfo' id="twoFactorInfo"><fmt:message key="${bean.twoFactorAuthSetupRequired? 'Two_Factor_Setup_Required' : 'Two_Factor_Auth_Required'}"/></div>
                                        </td>
                                    </tr>
                                    <tr>
                                         <td>
                                            <div class='ZTwoFactorCodeLabel' ><fmt:message key='Code'/>:</div>
                                        </td>
                                        <td>
                                            <input class="ZTwoFactorCodeInput" type="text" id="code" name="code" value="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>
                                            <div class='ZTwoFactorError' id="twoFactorErrorDiv">
                                                <c:if test="${bean.twoFactorAuthFailed}">
                                                    <fmt:message key='Two_Factor_Auth_Failed'/>
                                                </c:if>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <table border=0 cellpadding=0 cellspacing=0 width=100% class="ZTableInner">
                                                <tr>
                                                    <td>
                                                        <table border=0>
                                                            <tr>
                                                                 <td><div id="verifyButton" class="ZPanelButton" onclick='OnSubmit()' onmouseover='zd.OnHover(this, true)' onmouseout='zd.OnHover(this)'><fmt:message key='Verify'/></div></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td align="right">
                                                        <table border=0>
                                                            <tr>
                                                                <td><div id="cancelTotpButton" class="ZPanelButton ZCancel" onclick='OnCancelTwoFactor()' onmouseover='zd.OnHover(this, true)' onmouseout='zd.OnHover(this)'><fmt:message key='Cancel'/></div></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                ...
                <tr>
                    <td class="ZPanelInfoOuter"   id="accountDetails" style="${(bean.twoFactorAuthRequried) ? 'display: none' : 'display:block'}">
                        <div class="ZPanelInfoInner">
                            <center>
                            <table border=0 cellpadding=0 cellspacing=0 class="ZTable">
                                <tr>
                                    <td colspan=2 id="errorDesc">
                                        <c:choose>
                                ...
                                <c:if test="${not empty accountFlavor}">
                                    <form name="accountForm" action="${uri}" method="POST" onsubmit="OnSubmit();">
                                        ...
                                        <input type="hidden" name="twoFactorCode" id="twoFactorCode" value="">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ${zdf:reload(bean)}
                                                 <c:choose>
                                                     <c:when test="${bean.twoFactorAuthSetupRequired}">
                                                         <script>
                                                             OnApplyTwoFactor("<fmt:message key='Two_Factor_Setup_Required'/>");
                                                         </script>
                                                     </c:when>
                                                     <c:when test="${bean.twoFactorAuthRequried}">
                                                         <script>
                                                             OnApplyTwoFactor("<fmt:message key='Two_Factor_Auth_Required'/>");
                                                         </script>
                                                     </c:when>
                                                 </c:choose>
                                            </c:otherwise>
                                        ...
                                        <tr>
                                            ...
                                            <td width=90%>
                                                <input class="ZField" type="text" id="accountName" name="accountName" value="${fn:escapeXml(bean.accountName)}">
                                            </td>
                                        </tr>
                                        <c:if test="${bean.type ne 'zimbra'}">
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="ZField" type="text" id="fromDisplay" name="fromDisplay" value="${fn:escapeXml(bean.fromDisplay)}">
                                                </td>
                                            </tr>
                                        </c:if>
                                        <tr id="emailRow">
                                            ...
                                            <td>
                                                <input class="ZField" type="text" id="email" name="email" value="${fn:escapeXml(bean.email)}" <c:if test="${not empty bean.accountId}">disabled="disabled"</c:if>>
                                            </td>
                                        </tr>
                                            ...
                                            <c:if test="${bean.usernameRequired}">
                                                ...
                                                <c:if test="${bean.type eq 'xsync'}">
                                                    <tr>
                                                        ...
                                                        <td><input class="ZField" type="text" id="domain" name="domain" value="${fn:escapeXml(bean.domain)}"></td>
                                                    </tr>
                                                </c:if>
                                                <tr id="usernameRow">
                                                    <td>
                                                    ...
                                                    <td>
                                                        <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input class="ZField" type="text" id="smtpUsername" name="smtpUsername" value="${fn:escapeXml(bean.smtpUsername)}" onkeypress='zd.markElementAsManuallyChanged(this)'>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width=35%>
                                                                ...
                                                                <td>
                                                                    <table border=0 cellpadding=0 cellspacing=0 width=100% class="ZTableInner">
                                                                        <tr>
                                                                            <td>
                                                                                <input class="ZField" type="password" id="smtpPassword" name="smtpPassword" value="${fn:escapeXml(bean.smtpPassword)}" disabled="disabled"></td>
                                                    ...
                                                    <td>
                                                        <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input class="ZField" type="text" id="replyToDisplay" name="replyToDisplay" value="${fn:escapeXml(bean.replyToDisplay)}" onkeypress='zd.markElementAsManuallyChanged(this)'>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width=35%>
                                                                ...
                                                                <td>
                                                                    <input class="ZField" type="text" id="replyTo" name="replyTo" value="${fn:escapeXml(bean.replyTo)}" onkeypress='zd.markElementAsManuallyChanged(this)'>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>

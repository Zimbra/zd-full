...
var ZMTB_MailActions = function(zmtb)
{
	...
	this._folderMan.setFilter("mail", {first:[2, 5, 6, 4], exclude:[3, 14], type:"message", root:"Folders(Root)"});
	this._folderMan.setFilter("search", {first:[2, 5, 6, 4], exclude:[3, 14], type:"message", root:"Folders(Root)", search:true});
	this._initContext();
	this._initMenu();
	this._initActions();
}

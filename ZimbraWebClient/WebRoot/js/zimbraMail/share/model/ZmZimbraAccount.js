...
/**
 * Defines the error code for two factor authentication setup not complete failure.
 */
ZmZimbraAccount.TWO_FACTOR_SETUP_REQUIRED = "account.TWO_FACTOR_SETUP_REQUIRED";
/**
 * Defines the error code for two factor authentication required.
 */
ZmZimbraAccount.TWO_FACTOR_AUTH_REQUIRED = "account.TWO_FACTOR_AUTH_REQUIRED";
/**
 * Defines the error code for two factor trusted token has expired.
 */
ZmZimbraAccount.TWO_FACTOR_AUTH_EXPIRED = "account.TWO_FACTOR_AUTH_EXPIRED";
/**
 * Defines the error code for two factor authentication failure.
 */
ZmZimbraAccount.TWO_FACTOR_AUTH_FAILED = "account.TWO_FACTOR_AUTH_FAILED";
...
function(acctInfo) {
	...
	//Check for both state as well matching code in that state.
	if ((this.status != acctInfo.status) || (this.code != acctInfo.code)){

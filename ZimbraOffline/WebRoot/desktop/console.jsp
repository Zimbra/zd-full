...
function OnLogin() {
    ...
    var link = "${zdf:addAuthToken('/desktop/login.jsp', pageContext.request)}";

    if (link.indexOf("?") > -1) {
        link = link + "&showPwdLock=false";
    } else {
        link = link + "?showPwdLock=false";
    }
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${param.verb eq 'add'}">
                                                                <div id="message" class="ZInfo">
                                                                    <fmt:message key='ServiceAdded'><fmt:param>${fn:escapeXml(param.accountName)}</fmt:param></fmt:message>
                                                            ...
                                                            <c:otherwise>
                                                                ...
                                                                <div id="message" class="ZInfo">
                                                                    <fmt:message key="${key}"><fmt:param>${fn:escapeXml(param.accountName)}</fmt:param></fmt:message>
                                                                </div>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </td>
                                                                        ...
                                                                        <table border=0 width=100% class="${not empty account.errorCode ? 'ZAccountHeaderBad' : 'ZAccountHeaderGood'}">
                                                                            <tr>
                                                                                <td>
                                                                                    <table border=0>
                                                                                        <tr>
                                                                                            <td><div class="ZAccountName">${fn:escapeXml(account.name)}</div></td>
                                                                                            <c:if test="${not default}">
                                                                                                <td>
                                                                                                    <a title='<fmt:message key="SetAsDefault"/>' href="javascript:OnDefault('${account.id}', '${fn:escapeXml(fn:replace(account.name, "'", "\\'"))}', '${account.type}', '${account.flavor}')">
                                                                                ...
                                                                                <td align=right class="ZAccountActions">
                                                                                    <a href="javascript:OnEdit('${account.id}', '${fn:escapeXml(fn:replace(account.name, "'", "\\'"))}', '${account.type}', '${account.flavor}')"><fmt:message key="Edit"/></a>&nbsp;
                                                                                    <a href="javascript:OnDelete('${account.id}', '${fn:escapeXml(fn:replace(account.name, "'", "\\'"))}', '${account.type}', '${account.flavor}')"><fmt:message key="Delete"/></a>&nbsp;
                                                                                    <a href="javascript:OnReset('${account.id}', '${fn:escapeXml(fn:replace(account.name, "'", "\\'"))}', '${account.type}', '${account.flavor}')"><fmt:message key="ResetData"/></a>&nbsp;
                                                                                    <a href="javascript:OnReindex('${account.id}', '${fn:escapeXml(fn:replace(account.name, "'", "\\'"))}', '${account.type}', '${account.flavor}')"><fmt:message key="Reindex"/></a>
                                                                                    <c:if test="${account.flavor eq 'Zimbra'}">
                                                                                        &nbsp;
                                                                                        <a href="javascript:OnResetGal('${account.id}', '${fn:escapeXml(fn:replace(account.name, "'", "\\'"))}', '${account.type}', '${account.flavor}')"><fmt:message key="ResetGal"/></a>
                                                                                    </c:if>
                                                                                </td>
                                                                            </tr>
                                                                        </table>

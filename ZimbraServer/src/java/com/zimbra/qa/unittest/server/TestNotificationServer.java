...
extends TestCase {
    ...
    throws Exception {
        ...
        attrs.put(Provisioning.A_zimbraPrefOutOfOfficeReplyEnabled, LdapUtil.LDAP_TRUE);
        attrs.put(Provisioning.A_zimbraPrefOutOfOfficeReply, OUT_OF_OFFICE_BODY);
        attrs.put(Provisioning.A_zimbraPrefNewMailNotificationEnabled, LdapUtil.LDAP_TRUE);

    ...
    <tr>
        ...
        <td nowrap align=right>
            <c:if test="${context.hasPrevItem}">
                ...
                <a <c:if test="${keys}"></c:if> href="${prevItemUrl}"><app:img altkey="left" src="startup/ImgLeftArrow.png" border="0"/></a>
            </c:if>
            <c:if test="${!context.hasPrevItem}">
            ...
            <c:if test="${context.hasNextItem}">
                ...
                <a <c:if test="${keys}"></c:if> href="${nextItemUrl}"><app:img altkey="right" src="startup/ImgRightArrow.png" border="0"/></a>
            </c:if>
            <c:if test="${!context.hasNextItem}">

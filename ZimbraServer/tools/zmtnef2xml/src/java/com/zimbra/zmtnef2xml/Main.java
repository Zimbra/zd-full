...
public class Main {
    ...
    static {
        ...
        myMap.put(0x00000012L, "PidLidWeekInterval");
        myMap.put(0x00000013L, "PidLidMonthInterval");
        myMap.put(0x00000014L, "PidLidYearInterval");
    ...
    static {
        ...
        myMap.put(0x00008231L, "PidLidRecurrenceType");
    ...
    static {
        ...
        myMap.put(0x00008502L, "PidLidReminderTime");
        ...
        myMap.put(0x00008560L, "PidLidReminderSignalTime");
    ...
    static {
        ...
        myMap.put(0x00008104L, "PidLidTaskStartDate");
        myMap.put(0x00008105L, "PidLidTaskDueDate");
        ...
        myMap.put(0x00008111L, "PidLidTaskEstimatedEffort");
        myMap.put(0x00008112L, "PidLidTaskVersion");
        myMap.put(0x00008113L, "PidLidTaskState");
        myMap.put(0x00008115L, "PidLidTaskLastUpdate");
        myMap.put(0x00008116L, "PidLidTaskRecurrence");
        ...
        myMap.put(0x0000811fL, "PidLidTaskOwner");
        myMap.put(0x00008120L, "PidLidTaskMultipleRecipients");
        ...
        myMap.put(0x00008126L, "PidLidTaskFRecurring");
        myMap.put(0x00008127L, "PidLidTaskRole");
        myMap.put(0x00008129L, "PidLidTaskOwnership");
        myMap.put(0x0000812aL, "PidLidTaskAcceptanceState");
        myMap.put(0x0000812cL, "PidLidTaskFFixOffline");
